...
class Ui_CameraWindow(object):
    open_inquiry_signal = pyqtSignal()
    ...
    def setupUi(self, CameraWindow):
        ...
        self.actionOpen = QtWidgets.QAction(CameraWindow)
        ...
        self.actionOpen.triggered.connect(self.clicked)

    def retranslateUi(self, CameraWindow):
        _translate = QtCore.QCoreApplication.translate
        CameraWindow.setWindowTitle(_translate("CameraWindow", "jkam"))
        self.menuFile.setTitle(_translate("CameraWindow", "File"))
        self.actionOpen.setText(_translate("CameraWindow", "Open"))
